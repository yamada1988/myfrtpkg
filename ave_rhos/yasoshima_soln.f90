...
allocate(w(0:set_num,set_line),s(0:set_num,set_line))
 ...
 open(34,file="slvfe_dir/soln/log.tt")
 write(34,*) "sample_num=", sample_num
 close(34)

 open(20,file="slvfe_dir/soln/weight_soln")
 do i=1,set_line
...
allocate(e_num(0:set_num,set_line))
  ...
  do l=k0,set_num-1
   ...
   write(fname3,"('ERmod_',i4.4,'/soln/weight_soln')") l+1
  ...
  write(fname2,"('slvfe_dir/soln/aveuv.tt')") 
  open(20,file=fname2)
  do i=1,set_line
...
allocate(e_num(0:set_num,set_line))
 ...
 do k=1,5
  ...
  write(fname2,"('slvfe_dir/soln/engsln.'i2.2)") k
  open(20,file=fname2)
  do i=1,set_line
